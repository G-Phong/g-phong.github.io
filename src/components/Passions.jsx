...
>
  ...
  <div>
    ...
    <p className="legend">Soccer has always been a passion of mine ⚽</p>
  </div>
  <div>
    <img src={img_gartenhaus} alt="Gartenhaus" />
    <p className="legend">Every now and then it gets a bit more mechanical 🏠</p>
  </div>
  <div>
    <img src={img_vietnam} alt="Vietnam" />
    <p className="legend">My Asian roots lie in beautiful Vietnam 🇻🇳</p>
  </div>
  <div>
    <img src={img_internationals} alt="International Experiences" />
    <p className="legend">Getting to know people from other cultures inspires me 🌍</p>
  </div>
  <div>
    <img src={img_phong_greek_flag} alt="Greek Flag" />
    <p className="legend">Living abroad, like in Greece, are particularly special for me 🇬🇷</p>
  </div>
  <div>
    <img src={img_phong_gym} alt="Gym Workout" />
    <p className="legend">Being fit and staying fit is part of everyday life 💪</p>
  </div>
  <div>
    <img src={img_phong_science} alt="Science in Prague" />
    <p className="legend">The strong will to always learn new things and grow 📚</p>
  </div>
  <div>
    <img src={img_phong_tum_graduate} alt="Graduation from TUM" />
    <p className="legend">The breathtaking feeling of having achieved something and then continuing to grow beyond it 🎓</p>
  </div>
  <div>
    <img src={img_foodtruck} alt="Foodtruck" />
    <p className="legend">Food is one of my passions, so I worked in a burger food truck 🍔</p>
  </div>
  <div>
    <img src={img_thaiboxen} alt="Thai Boxing" />
    <p className="legend">Martial arts gives me focus and adrenaline 🥊</p>
  </div>
  <div>
    <img src={img_insi_singen} alt="Insi Singen" />
    <p className="legend">Contributing to society fulfills me 🌟</p>
  </div>
</Carousel>
